...
create procedure sp_create_user_system_role
(
    p_username varchar,
    p_password varchar,
...
begin
    ...
    into v_role_id
    from role
    where lower(name) = 'system';

    if v_role_id is null then
            raise exception 'Role "system" does not exist';
    end if;
...
/*
call register_system('system', 'system');

select password = crypt('system', password)
from _user
